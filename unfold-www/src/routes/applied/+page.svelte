...
<main class="fixed inset-0 flex flex-col items-center justify-center px-8 text-center">
	<p class="text-white font-serif text-2xl md:text-3xl max-w-xl leading-relaxed">
		welcome to unfold. check slack! we just added you to the channels. see you in july :D
	</p>

	<p class="text-white/80 font-serif text-xl md:text-2xl tracking-[0.2em] mt-16 max-w-md">
		ꕥ
	</p>

	<a
		href="/"
		class="text-white/30 hover:text-white/60 font-serif text-sm tracking-[0.3em] mt-24 transition-colors duration-300"
	>
		← back home
	</a>
</main>
